        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                I clean messy datasets, explore patterns, and turn insights into visuals that make execs go "oh wow."
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                I turn raw data into real-time dashboards and automate reporting so teams can make smarter decisions faster.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                ...
                <div className="what-tags">Business storytelling</div>
              </div>
              <div className="what-arrow"></div>
            </div>
          </div>
